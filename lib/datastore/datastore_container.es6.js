  ...
  properties: [
    ...
    },
    {
      ...
      factory: function() {
        ...
        return this.mode.decorateContainerContext(ctx);
      },
    },
    {
  ...
  values: [
    {
      ...
      decorateContainerContext: function(ctx) {
        // Web service runs in a secure box context.
        return ctx.createSubContext(this.Context.create({
          unsafe: false,
          classWhitelist: require('../../data/class_whitelist.json'),
        }, ctx));
    ...
    },
    {
      ...
      decorateContainerContext: function(ctx) {
        // Data collector uses default container context. Importantly, it does
        // not create a secure box context.
        return ctx;
      },
    },
    {
        ...
        let clientDAO = this.ConfluenceClientDAO.create({
          ...
          delegate: this.stubFactory.get(this.BoxRegistry).create({
            ...
            data: this.ConfluencePollingDAO.create({
              of: cls,
              url: `https://storage.googleapis.com/web-api-confluence-data-cache/archive/json/${cls.id}.json`,
            }, ctx),
          })),
        }, ctx);
