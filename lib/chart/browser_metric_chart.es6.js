...
function browserMetricChartController($scope, $timeout) {
  let createNewView = function(release, prevReleases, comparedReleases, date) {
    this.createNewView({release, prevReleases, comparedReleases, date});
  }.bind(this);
