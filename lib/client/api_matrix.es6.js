...
foam.CLASS({
  ...
  methods: [
    function init() {
      this.releaseDAO.sub('on', 'reset', this.onResetReleases);
      this.releaseWebInterfaceJunctionDAO.sub('on', 'reset', this.onResetAPIs);
      this.webInterfaceDAO.sub('on', 'reset', this.onResetAPIs);
      this.SUPER();
    },
    {
      name: 'getReleases',
      ...
      code: function() {
        ...
        return this.releaseDAO.select().then((arraySink) => {
          console.log('Gathering releases');
          let releases = {};
  ...
  listeners: [
    function onResetReleases() {
      console.log('onResetReleases');
      this.pub('on', 'reset', 'releases');
    },
    function onResetAPIs() {
      console.log('onResetAPIs');
      this.pub('on', 'reset', 'apis');
    },
  ]
});
