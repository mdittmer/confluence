...
foam.CLASS({
  ...
  methods: [
    ...
    {
      name: 'getClassName_',
      documentation: `Search object id's prototype chain to find the class it
        belongs to. The class is the prototype with a constructor property.`,
      args: [
        {
    ...
    },
    {
      ...
      code: function(og, map, id, name, visited, opt) {
        ...
        if (og.isFunction(id) && (proto || firstLevel)) {
          ...
          // Object is not BOTH:
          // A function, AND
          // A __proto__ of some other entity or first level.
