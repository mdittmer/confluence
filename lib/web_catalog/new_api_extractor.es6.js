  ...
  methods: [
    ...
    function getAllProtosAPIs_(og, id) {
      ...
      while (!og.isType(lowerProtoId)) {
        apis = this.apisConcat_(apis, this.getAPIs_(og, lowerProtoId));
        lowerProtoId = og.getPrototype(lowerProtoId);
      }
      return apis;
    },
    ...
    function getAPIs_(og, id) {
      if (id === this.objectDotPrototype_) {
        ...
        return og.getObjectKeys(id)
            .filter(name => name !== 'prototype')
            .filter(this.filterConstants_.bind(this, og, id));
      }
    ...
    function filterConstants_(og, id, name) {
      ...
      code: function(og) {
        ...
        for (const id in this.sources_) {
          ...
          for (const interfaceName of interfaceNames) {
            sources[interfaceName] = sources.hasOwnProperty(interfaceName) ?
